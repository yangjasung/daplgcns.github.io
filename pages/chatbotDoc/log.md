...
챗봇 사용 이력 확인할 수 있도록 다음 2가지 종류의 대화 이력 페이지를 제공하고 있습니다.
...
의도 추론 페이지를 보다 활용할 수 있도록 문장을 Intent에 바로 추가할 수 있는 기능을 제공합니다. 문장을 기존 Intent에 추가에 추가하거나 혹은 새로운 Intent 생성하여 추가하실 수 있습니다.
